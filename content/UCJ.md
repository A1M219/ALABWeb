...
- ![USJ-1](../assets/img/UCJ/UCJ-1.png)
- ![USJ-2](../assets/img/UCJ/UCJ-2.png)
2. 运行服务器测试，出现下列指令时说明安装成功。
- ![USJ-3](../assets/img/UCJ/UCJ-3.png) 
## 2.安装新插件
...
- ![USJ-4](../assets/img/UCJ/UCJ-4.png) 
2. 复制完成后运行服务器测试
- ![USJ-5](../assets/img/UCJ/UCJ-5.png) 
## 3.权限组
1. 调整权限组让所有人都能用home命令，找到并打开U3DS\Servers\AlabServer\Rocket\Permissions.config.xml文件，可以看到当前权限组设置。
- ![USJ-6](../assets/img/UCJ/UCJ-6.png) 
2. 将homo插件的玩家权限加入到默认权限组，加到[<Permission Cooldown="0">rocket</Permission>]的后面，如果需要添加其他插件的指令，请去查阅U3DS\Servers\AlabServer\Rocket\Commands.config.xml文件。
```
...
```
- ![USJ-7](../assets/img/UCJ/UCJ-7.png) 
3. 进入服务器测试
## 交流群562958446